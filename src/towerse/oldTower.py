...
if __name__ == '__main__':
    ...
    tower.plidx2 = [n-1]  # at tower top
    tower.Fx2 = [930198.60063279]
    tower.Fy2 = [0.]
    tower.Fz2 = [-2883106.12368949]
    tower.Mxx2 = [-1683669.22411597]
    tower.Myy2 = [-2522475.34625363]
    tower.Mzz2 = [147301.97023764]
    # # ---------------
